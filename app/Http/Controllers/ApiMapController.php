...
class ApiMapController extends Controller
{
  ...
  public function admin()
  {
    ...
    return [
      ...
      'AdminIpPoolList' => $base_url . '/api/Admin/IpPool/list?page=${page}',
      ...
      'AdminRequestLogList' => $base_url . '/api/Admin/RequestLog/list?page=${page}',
      'AdminUploadList' => $base_url . '/api/Admin/Upload/list?page=${page}',
      ...
      'AdminAdminList' => $base_url . '/api/Admin/Admin/list?page=${page}',
